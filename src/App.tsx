  ...
  return (
    <div className="min-h-screen bg-[#eef2ff] font-sans text-[#1e1b4b] antialiased relative selection:bg-blue-600 selection:text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute inset-0 doodle-bg opacity-[0.7] mix-blend-multiply [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,#000_40%,transparent_100%)]"></div>
      </div>
