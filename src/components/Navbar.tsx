          ...
          <div className="hidden lg:flex items-center gap-2">
            {navLinks.map((link, i) => (
              <motion.a
                ...
                className="px-4 py-2 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-indigo-950/60 hover:text-blue-600 hover:bg-blue-50/50 rounded-full transition-all"
              >
                {link.name}
              </motion.a>
            ))}
